...
output_flye="/core/projects/EBP/conservation/japanese_walnut/Student_Japanese_walnut_dir/assembly/07_purge_haplotigs/Flye_Purge/curated.fasta"
output_prefix="flye_purge"
