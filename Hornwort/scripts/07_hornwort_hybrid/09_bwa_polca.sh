...
INDEXDIR=../../results/07_hornwort_hybrid/evaluation/polca/alignment/bwa/index
mkdir -p $INDEXDIR
...
OUTDIR=../../results/07_hornwort_hybrid/evaluation/polca/alignment/bwa
mkdir -p $OUTDIR
