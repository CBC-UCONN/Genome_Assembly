...
INDEXDIR=../../results/07_hornwort_hybrid/evaluation/masurca/alignment/bwa/index
mkdir -p $INDEXDIR
...
OUTDIR=../../results/07_hornwort_hybrid/evaluation/masurca/alignment/bwa
mkdir -p $OUTDIR
