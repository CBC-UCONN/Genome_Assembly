...
INDEXDIR=../../results/05_hornwort_ONT/evaluation/medaka/alignment/bwa/index
mkdir -p $INDEXDIR
...
OUTDIR=../../results/05_hornwort_ONT/evaluation/medaka/alignment/bwa
mkdir -p $OUTDIR
